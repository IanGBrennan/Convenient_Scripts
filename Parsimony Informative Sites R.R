...
all <- read.nex("/Users/Ian/Google.Drive/Villanova Herp Work/Assorted Geckos - Blaesodactylus, Lygodactylus, Dixonius & Others/Pachydactylus and Chondrodactylus/Chondro.RAG.ips.nex")
pis(all, what="absolute", use.ambiguities=F)
nd2 <- read.nex("/Users/Ian/Google.Drive/Villanova Herp Work/Assorted Geckos - Blaesodactylus, Lygodactylus, Dixonius & Others/Pachydactylus and Chondrodactylus/Chondro.ND2.ips.nex")
rag <- read.nex("/Users/Ian/Google.Drive/Villanova Herp Work/Assorted Geckos - Blaesodactylus, Lygodactylus, Dixonius & Others/Pachydactylus and Chondrodactylus/Chondro.RAG.ips.nex")
pdc <- read.nex("/Users/Ian/Google.Drive/Villanova Herp Work/Assorted Geckos - Blaesodactylus, Lygodactylus, Dixonius & Others/Pachydactylus and Chondrodactylus/Chondro.PDC.ips.nex")
pis(nd2, what="absolute", use.ambiguities=F)
pis(rag, what="absolute", use.ambiguities=F)
pis(pdc, what="absolute", use.ambiguities=F)
